        ...
        <div className='footer-col'>
            ...
            <div className='footer-row'>
                ...
                <ul className='footer-li-icontainer'>
                    ...
                    <li><a className='footer-li-icon' href='https://instagram.com/chandan.sonii' target='_blank'> <FontAwesomeIcon icon={faInstagram} /></a> </li>
                    <li><a className='footer-li-icon' href='https://linkedin.com/in/chandan-soni-10926a1b5' target='_blank'> <FontAwesomeIcon icon={faLinkedin} /></a> </li>
